...
<section id="collections" data-theme-trigger="hero">
  <div class="wrap">
    <div class="coll-head">
      ...
      <p class="lede rv" style="margin-top:0">Each article is pure silver, weighed before you and priced on the day's rate. Walk in, hold it, feel its weight settle in your palm — the way silver has been chosen in Nagarthpet for generations.</p>
    </div>
